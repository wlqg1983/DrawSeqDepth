...
if [[ $# -lt 3 ]]; then
    ...
    echo "Usage: bash bowtie2.paired.sh reference.fasta input1.fastq input2.fastq output_dir [flag]"
    exit 1
fi
...
bowtie2 -x "$reference_name" -1 "../$input_fastq1" -2 "../$input_fastq2" -S "output.sam"
